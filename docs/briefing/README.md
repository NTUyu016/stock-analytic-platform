...
| [`16-performance.md`](./16-performance.md) | [#16 歷史快照與績效計算策略](https://github.com/NTUyu016/stock-analytic-platform/issues/16) | ✅ **已定案**（2026-08-07）— 決策見 [`performance.md`](../spec/performance.md)；本文保留為證據來源 |
