...
| 盤後批次 | 每日 22:00 之後 | `daily_close`、`benchmark_series`、`exchange_rate` 回補；除權息與**分割**偵測（見 [`corporate-actions.md`](./corporate-actions.md)）；成交量異常計算 |
...
| Healthchecks.io | **NT$0**（免費層 20 jobs，本專案用 4） |
